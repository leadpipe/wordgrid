  ...
  `}render(){const{category:e}=this,t=$e.scoreWord(this.word);return s.dy`
    ...
    `}renderFoundWords(e,t){return s.dy`
      <div id="found" class="may-scroll">
        ${(0,Ue.r)(this.gameState?.getFoundWords()??[],(e=>e),(e=>s.dy`
            <div>
              <solution-word
                word=${e}
                theme=${this.theme}
