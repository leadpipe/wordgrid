...
`;var Y=function(e,t,i,s){var o,r=arguments.length,a=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(r<3?o(a):r>3?o(t,i,a):o(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};let Q=class extends s.oi{constructor(){super(...arguments),this.theme="light",this.puzzleId=null,this.puzzle=null,this.isPaused=!0,this.isInteractive=!1,this.keyHandler=e=>this.handleKeyDown(e),this.resizeObserver=new ResizeObserver((async()=>{this.calcMetrics()})),this.trail=[],this.outOfBounds=!1,this.prefixes=[],this.pendingKeyboardInput="",this.pendingInputTimeoutId=0,this.cellSpan=0,this.sidePixels=0}static{this.styles=[s.iv`
  ...
  `}render(){const{category:e}=this,t=ve.scoreWord(this.word);return s.dy`
      ...
      ${this.open?s.dy`
          ...
          `:""}
    `}shouldUpdate(e){return e.has("expand")&&this.expand!==this.open&&(this.open=this.expand),!0}toggle(e){this.open=!this.open,this.dispatchEvent(new CustomEvent("word-expanded",{detail:this.open?this.word:"",bubbles:!0,composed:!0})),this.timeoutId&&(window.clearTimeout(this.timeoutId),this.timeoutId=0),this.open&&(this.timeoutId=window.setTimeout((()=>{this.open&&this.toggle(),this.timeoutId=0}),2500))}};Ce([(0,o.Cb)()],Ee.prototype,"word",void 0),Ce([(0,o.Cb)({type:Number})],Ee.prototype,"category",void 0),Ce([(0,o.Cb)()],Ee.prototype,"theme",void 0),Ce([(0,o.Cb)({type:Boolean})],Ee.prototype,"expand",void 0),Ce([(0,o.SB)()],Ee.prototype,"open",void 0),Ee=Ce([(0,o.Mo)("solution-word")],Ee);var Oe,De=i(455),Re=i(36);function We(e,t={}){gtag("event",e,t)}!function(e){e.ACTION="wg_action",e.SYSTEM="wg_system"}(Oe||(Oe={}));const Le=new Worker(new URL(i.p+i.u(975),i.b),{name:"words"});Le.onerror=e=>{We(Oe.SYSTEM,{category:"words worker error",detail:String(e)})};const Ue=[];function Be(e){return new Promise(((t,i)=>{Ue.push({message:e.toMakeGridMessage(),resolve:t,reject:i}),1===Ue.length&&Ae()}))}function Ae(){Ue.length&&Le.postMessage(Ue[0].message)}Le.onmessage=e=>{if(!Ue.length)return void We(Oe.SYSTEM,{category:"words worker unexpected message",detail:JSON.stringify(e)});const t=Ue.shift();if(Ae(),e.data.message.seed===t?.message.seed)switch(e.data.type){case ie.GRID:void 0!==e.data.wordsLoadMs&&We(Oe.SYSTEM,{category:"words worker load-words time",elapsedMs:e.data.wordsLoadMs}),void 0!==e.data.elapsedMs&&We(Oe.SYSTEM,{category:"words worker make-grid time",detail:e.data.message.seed,elapsedMs:e.data.elapsedMs}),t.resolve(e.data);break;case ie.UNKNOWN_VERSION:We(Oe.SYSTEM,{category:"words worker unknown version",detail:`${e.data.message.version} vs ${e.data.versions}`}),t.reject(`The words worker can't honor the version we asked for, ${e.data.message.version}`)}else We(Oe.SYSTEM,{category:"words worker wrong puzzle received",detail:`${JSON.stringify(e.data.message)} instead of ${JSON.stringify(t?.message)}`})};var Me=function(e,t,i,s){var o,r=arguments.length,a=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(r<3?o(a):r>3?o(t,i,a):o(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};let Fe=class extends s.oi{constructor(){super(...arguments),this.theme="light",this.puzzleId=ne.daily(),this.resumeImmediately=!1,this.loadingWords=!0,this.puzzle=null,this.gameState=null,this.db=ge(),this.foregroundnessHandler=()=>{"visible"!==document.visibilityState&&this.pauseGame("foregroundness")},this.windowBlurHandler=()=>{this.pauseGame("window blur")},this.lastInteraction=new Date,this.spacebarHandler=e=>{this.noteInteraction()," "===e.key&&(this.gameState?.isPaused?this.resumePlay():this.pauseGame("spacebar"))},this.showTimerHandler=()=>{this.requestUpdate()},this.gridTransitionQueue=[],this.gridTransitionClasses={},this.pendingWords=[],this.pendingWordsJudgements=[],this.pendingWordsTimeoutId=0,this.latestWord=""}static{this.styles=[q,s.iv`
      :host {
        position: fixed;
        top: 0;
        right: 0;
    ...
    `]}render(){const{theme:e,gameState:t}=this,i=e===l?"light"===e?"dark":"light":"auto";return s.dy`
      ...
      <div id="grid">
        <grid-view
          theme=${e}
          class=${(0,De.$)(this.gridTransitionClasses)}
          isInteractive
